        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(i=0;i<data.length;i++){
                    ...
                    content_data += "<td>"+data[i].no_anggota+"</td>";
                    ...
                    if(data[i].status == 1){
                        content_data += "<td><span class='badge bg-red'>Deactive</span></td>";
                    }else{
                        content_data += "<td><span class='badge bg-green'>Active</span></td>";
                    }
                    content_data += "<td><a href='#' onclick='deactivedata("+data[i].id+")'";
                    content_data += "	class='btn btn-secondary' title='Deactive'><img alt='image' class='img-md' ";
                    content_data += " src='<?php echo base_url(); ?>assets/img/flaticon/criss-cross.png'></a> ";
                    ...
                    content_data += "   <a href='#' onclick='activedata("+data[i].id+")'";
                    content_data += "	class='btn btn-secondary' title='Active'><img alt='image' class='img-md' ";
                    content_data += " src='<?php echo base_url(); ?>assets/img/flaticon/tick2.png'> </a></td>";
                    content_data += "</tr>";
...
function deactivedata(id){
    ...
    if (confirm('Are you sure want to deactive this data?')) {
        $.ajax({
            type: 'POST',
            url:base_url+"anggota/status",
            data: str_data,
            success: function (result) {
                
                window.location = base_url+'anggota/index';
...
function activedata(id){
    ...
    if (confirm('Are you sure want to active this data?')) {
        $.ajax({
            type: 'POST',
            url:base_url+"anggota/status",
            data: str_data,
